...
@XmlRootElement(name = "IpPermissions")
public class IpPermissions {

    @XmlElement(nillable = true)
    protected List<IpPermissions.IpPermissionsItem> item;
     ...
     * {@link IpPermissions.IpPermissionsItem }
     * 
     * 
     */
    public List<IpPermissions.IpPermissionsItem> getItem() {
        if (item == null) {
            item = new ArrayList<IpPermissions.IpPermissionsItem>();
        }
        return this.item;
    }
    ...
    public static class IpPermissionsItem {
