...
public class CreateRouteResult extends JCSResult implements Serializable, Cloneable {
	...
	public CreateRouteResult(boolean _return) {
		super();
	...
	public CreateRouteResult withReturn(boolean _return){
		setReturn(_return);
		return this;
	}
