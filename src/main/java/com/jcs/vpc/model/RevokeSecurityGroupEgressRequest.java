...
public class RevokeSecurityGroupEgressRequest extends JCSRequest implements Serializable, Cloneable{
	...
	public RevokeSecurityGroupEgressRequest(String groupId, List<IpPermission> ipPermissions) {
		super();
	...
	public RevokeSecurityGroupEgressRequest withIpPermissions(List<IpPermission> ipPermissions){
