...
public class AuthorizeSecurityGroupIngressRequest extends JCSRequest implements Serializable, Cloneable {
	...
	public AuthorizeSecurityGroupIngressRequest(String groupId, List<IpPermission> ipPermissions) {
		super();
	...
	public AuthorizeSecurityGroupIngressRequest withIpPermissions(List<IpPermission> ipPermissions){
