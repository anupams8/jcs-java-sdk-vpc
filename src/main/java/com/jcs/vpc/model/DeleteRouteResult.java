...
public class DeleteRouteResult extends JCSResult implements Serializable, Cloneable {
	...
	public DeleteRouteResult(boolean _return) {
		super();
    ...
    public DeleteRouteResult withReturn(boolean _return) {
    	setReturn(_return);
    	return this;
    }
