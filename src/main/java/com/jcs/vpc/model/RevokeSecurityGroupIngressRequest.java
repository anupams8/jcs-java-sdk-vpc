...
public class RevokeSecurityGroupIngressRequest extends JCSRequest implements Serializable, Cloneable{
	...
	public RevokeSecurityGroupIngressRequest(String groupId, List<IpPermission> ipPermissions) {
		super();
